...
class KategoriController extends Controller
{
    ...
    {
        $request->validate([
            //Kategori_kode harus diisi,beruba string,minim 3 karakter,dan bernilai unik di tabel kategori kolom kategori_kode
    ...
    public function destroy(string $id)
{
    ...
    try{
        ...
        return redirect('/kategori')->with('succes','Data kategori berhasil dihapus');
    }catch(\Illuminate\Database\QueryException $e){

        return redirect('/kategori')->with('error','Dara kategori gagal dihapus karena masih terdapat tabel lain yang terkait dengan data ini');
    }
}
}
