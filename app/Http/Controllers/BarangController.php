...
{
    $request->validate([
        //barang_kode harus diisi,beruba string,minim 3 karakter,dan bernilai unik di tabel barang kolom barang_kode
...
public function destroy(string $id)
{
    ...
    try{
        ...
        return redirect('/barang')->with('succes','Data barang berhasil dihapus');
    }catch(\Illuminate\Database\QueryException $e){

        return redirect('/barang')->with('error','Dara barang gagal dihapus karena masih terdapat tabel lain yang terkait dengan data ini');
    }
}
}
